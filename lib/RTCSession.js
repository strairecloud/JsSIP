...
module.exports = class RTCSession extends EventEmitter
{
  ...
  answer(options = {})
  {
    ...
    Promise.resolve()
      ...
      .then(() =>
      {
        ...
        const offer = new wrtc.RTCSessionDescription({ type: 'offer', sdp: e.sdp });
      ...
      switch (request.method)
      {
        case JsSIP_C.ACK:
          ...
          if (this._late_sdp)
          {
            ...
            const answer = new wrtc.RTCSessionDescription({ type: 'answer', sdp: e.sdp });
  ...
  {
    this._connection = new wrtc.RTCPeerConnection(pcConfig, rtcConstraints);
